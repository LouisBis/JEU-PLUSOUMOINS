...
int main(int argc, char *argv[])
{
    ...
    scanf("%c",&reponseCoop);
    // Ici pas besoin de boucle  getchar() car aucun caractère n'a encore été stocké dans le buffer

    do
    {
        int nombreCoups = 0; // car si or de la boucle additionne les différentes parties
        ...
        while(getchar() != '\n');
        /* 
        permet de nettoyer le buffer (mémoire tampon) sinon le scanf %c ne marche pas
